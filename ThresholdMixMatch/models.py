...
class Dense121(nn.Module):
    def __init__(self, class_num):
        ...
        fea_dim = 256     #TODO 256->265    
        model_ft = models.densenet121(pretrained=False) # For pretrain model, use "True"
        ...
        model_ft.classifier = ClassBlock(1024, class_num) #TODO 1024->2048
